...
local Enable = function(self)
    if(self.freebIndicators) then
        ...
        self.AuraStatusTL.frequentUpdates = ThunderDB["UnitFramesRaid"]["FreqUpdate"]
        ...
        self.AuraStatusTR.frequentUpdates = ThunderDB["UnitFramesRaid"]["FreqUpdate"]
        ...
        self.AuraStatusBL.frequentUpdates = ThunderDB["UnitFramesRaid"]["FreqUpdate"]
        ...
        self.AuraStatusBR:SetFont(symbols, ThunderDB["UnitFramesRaid"]["IconSize"], "THINOUTLINE")
        self.AuraStatusBR.frequentUpdates = ThunderDB["UnitFramesRaid"]["FreqUpdate"]
        ...
        self.AuraStatusCen:SetFont(ThunderDB["UnitFramesRaid"]["FramesFont"], ThunderDB["UnitFramesRaid"]["FrameFontSize"]-1)
        self.AuraStatusCen:SetShadowOffset(1.25, -1.25)
        self.AuraStatusCen.frequentUpdates = ThunderDB["UnitFramesRaid"]["FreqUpdate"]
