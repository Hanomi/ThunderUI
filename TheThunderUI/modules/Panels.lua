...
{	name = "PetBarsBAGROUND",
	...
	x_off = ThunderDB[l_ab][l_abBusize]/2, y_off = fixscale(4),
	width = ThunderDB[l_ab][l_abBusize]*9+ThunderDB[l_ab][l_abOffset]*9,
	height = ThunderDB[l_ab][l_abBusize]+fixscale(8),
	scale = 1,
	bg_alpha = 0,
},
